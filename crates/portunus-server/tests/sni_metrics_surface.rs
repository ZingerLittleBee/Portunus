...
//! expected `portunus_tls_sni_*` lines are present with the right
//! labels and values.
//!
...
async fn per_rule_sni_counters_render_with_correct_labels() {
    ...
    assert_metric_line(
        &body,
        "portunus_tls_sni_route_total{client=\"edge-metrics-test\",owner=\"u-7\",result=\"exact\",rule=\"42\"} 10",
    );
    assert_metric_line(
        &body,
        "portunus_tls_sni_route_total{client=\"edge-metrics-test\",owner=\"u-7\",result=\"wildcard\",rule=\"42\"} 5",
    );
    assert_metric_line(
        &body,
        "portunus_tls_sni_route_total{client=\"edge-metrics-test\",owner=\"u-7\",result=\"fallback\",rule=\"42\"} 3",
    );
}
...
async fn per_rule_sni_counters_apply_monotonic_delta() {
    ...
    assert_metric_line(
        &body,
        "portunus_tls_sni_route_total{client=\"edge-metrics-test\",owner=\"u-7\",result=\"exact\",rule=\"7\"} 6",
    );
}
...
async fn per_rule_sni_counters_handle_baseline_reset() {
    ...
    assert_metric_line(
        &body,
        "portunus_tls_sni_route_total{client=\"edge-metrics-test\",owner=\"u-7\",result=\"exact\",rule=\"11\"} 104",
    );
}
...
async fn listener_counters_render_with_correct_labels() {
    ...
    assert_metric_line(
        &body,
        "portunus_tls_sni_listener_miss_total{client=\"edge-metrics-test\",port=\"443\"} 4",
    );
    assert_metric_line(
        &body,
        "portunus_tls_sni_listener_parse_failures_total{client=\"edge-metrics-test\",port=\"443\"} 3",
    );
}
...
async fn listener_counters_keep_separate_state_per_port() {
    ...
    assert_metric_line(
        &body,
        "portunus_tls_sni_listener_miss_total{client=\"edge-metrics-test\",port=\"443\"} 12",
    );
    assert_metric_line(
        &body,
        "portunus_tls_sni_listener_miss_total{client=\"edge-metrics-test\",port=\"8443\"} 7",
    );
}
...
async fn quiet_listener_does_not_emit_collector_lines() {
    ...
    assert_no_metric_line(
        &body,
        "portunus_tls_sni_listener_miss_total{client=\"edge-metrics-test\",port=\"443\"}",
    );
    assert_no_metric_line(
        &body,
        "portunus_tls_sni_listener_parse_failures_total{client=\"edge-metrics-test\",port=\"443\"}",
    );
}
...
async fn listener_peek_histogram_renders_bucket_sum_and_count() {
    ...
    assert_metric_line(
        &body,
        "portunus_tls_client_hello_peek_duration_seconds_bucket{client=\"edge-metrics-test\",le=\"0.0001\",port=\"443\"} 1",
    );
    assert_metric_line(
        &body,
        "portunus_tls_client_hello_peek_duration_seconds_bucket{client=\"edge-metrics-test\",le=\"3\",port=\"443\"} 4",
    );
    assert_metric_line(
        &body,
        "portunus_tls_client_hello_peek_duration_seconds_bucket{client=\"edge-metrics-test\",le=\"+Inf\",port=\"443\"} 4",
    );
    assert_metric_line(
        &body,
        "portunus_tls_client_hello_peek_duration_seconds_sum{client=\"edge-metrics-test\",port=\"443\"} 0.00375",
    );
    assert_metric_line(
        &body,
        "portunus_tls_client_hello_peek_duration_seconds_count{client=\"edge-metrics-test\",port=\"443\"} 4",
    );
}
...
async fn owner_label_uses_string_form_of_user_id() {
    ...
    assert_metric_line(
        &body,
        "portunus_tls_sni_route_total{client=\"edge-metrics-test\",owner=\"alice\",result=\"exact\",rule=\"99\"} 1",
    );
}
