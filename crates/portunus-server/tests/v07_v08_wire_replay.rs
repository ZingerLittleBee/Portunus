...
//! Companion to:
//!
//! - T007 (`crates/portunus-proto/tests/sni_wire_compat.rs`):
...
//! from the `portunus-e2e` integration suite. There is no such
...
use portunus_proto::v1::{Protocol as ProtoProtocol, Rule, RuleAction, RuleUpdate, Target};
use prost::Message;
