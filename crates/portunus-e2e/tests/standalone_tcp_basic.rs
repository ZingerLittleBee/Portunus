//! E2E: portunus-standalone forwards TCP echo (project-wide regression
//! mirror of crates/portunus-standalone/tests/smoke.rs).
...
"#
    ...
    #[cfg(unix)]
    {
        ...
        // SAFETY: we own the child handle so pid is valid for kill().
