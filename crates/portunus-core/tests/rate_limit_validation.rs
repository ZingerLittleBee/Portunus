//! Contract tests for the `portunus_core::rate_limit::validate`
...
//!   portunus-server contract test in T009).

use portunus_core::rate_limit::{RateLimit, RateLimitError, validate};
