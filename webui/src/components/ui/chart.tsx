...
} from "@/components/ui/recharts-resource"
...
type TooltipPayload = DefaultTooltipContentProps<
  TooltipValueType,
  TooltipNameType
>["payload"]
...
function ChartTooltipContent({
  ...
  React.ComponentProps<"div"> & {
    ...
    labelKey?: string
    /**
     * Convenience formatter for the value text only, keeping the default row
     * layout. Use `formatter` instead to replace the entire row.
     */
    valueFormatter?: (
...
function ChartLegend(props: RechartsLegendProps) {
...
function getTooltipLabel({
  ...
  labelFormatter: RechartsTooltipProps["labelFormatter"] | undefined
