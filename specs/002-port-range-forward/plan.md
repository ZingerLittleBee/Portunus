...
The change touches: `proto/portunus.proto` (additive fields), the server
...
**Project Type**: Multi-crate Cargo workspace (`portunus-core`,
...
├── contracts/
│   ├── portunus.proto    # Phase 1: additive proto diff (overlay vs MVP)
...
```text
proto/
└── portunus.proto                         # add optional listen_port_end, target_port_end
...
modules (`portunus-core/port_range.rs`,
`portunus-client/forwarder/range.rs`,
`portunus-server/operator/per_port_stats.rs`) keep range-specific code
