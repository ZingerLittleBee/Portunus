...
- [ ] T068 Run `quickstart.md` end-to-end on two real Linux hosts; capture wall-clock time for SC-001 (target < 5 minutes) — **loopback dry-run on macOS completed 2026-05-06 in 8.1 s post-build (release build itself ~30 s); two-real-Linux-hosts validation still pending**
