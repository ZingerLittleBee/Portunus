...
the script the `portunus-e2e` integration tests exercise programmatically.

## 0. Prerequisites

You need [`portunus-server` and `portunus-client` installed](/docs/getting-started/installation)
