...
throughput **doubled from 9.9 Gbit/s to 21.9 Gbit/s** (2.20×) and reaches the
offered rate end-to-end through 15 Gbit/s.
...
| 12.5 - 15 Gbit/s | With splice on, single-flow throughput stays within measurement noise of the kernel baseline. |
