...
`forward-client` is the edge-side binary. It dials a server endpoint
...
Run `forward-client --help` for the current authoritative surface.

## Environment variables

| Variable | Purpose |
| --- | --- |
| `FORWARD_CLIENT_BUNDLE` | Bundle path (highest precedence in resolution chain) |
