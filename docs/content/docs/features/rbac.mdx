...
description: Users, local Web passwords, API credentials, and per-tenant grants scoped to clients, port ranges, and protocols.
icon: Users
---
...
break-glass command on the host that owns the data dir:
